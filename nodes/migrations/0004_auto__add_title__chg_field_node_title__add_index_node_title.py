...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Node.title' to match new field type.
        db.rename_column(u'nodes_node', 'title', 'title_id')
        # Changing field 'Node.title'
        db.alter_column(u'nodes_node', 'title_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Title']))
        # Adding index on 'Node', fields ['title']
        db.create_index(u'nodes_node', ['title_id'])


    def backwards(self, orm):
        # Removing index on 'Node', fields ['title']
        db.delete_index(u'nodes_node', ['title_id'])
        ...
        # Renaming column for 'Node.title' to match new field type.
        db.rename_column(u'nodes_node', 'title_id', 'title')
        # Changing field 'Node.title'
        db.alter_column(u'nodes_node', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
