...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'nodes_node', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Incoherent Ramblings of a Biddyface', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.title'
        db.delete_column(u'nodes_node', 'title')
